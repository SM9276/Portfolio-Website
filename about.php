     ...
     <!-- First Computer  -->	
        ...
        <div class="card">
            <div class ="card-body">
                ...
                <p class="card-detail"> I got into installing custom Andriod OSes, I was rocking Linage OS running Andriod 7.1.2 on a Galaxy J7.
                I ended up helping the community around me, I would help the farm workers unlocking their SIM cards
                and improving their phones. </p>
            </div>
        </div>
        ...
        <div class="card">
            <div class ="card-body">
                ...
                We learned the fundementals of boolean logic and did assignments in html, css </p>
            </div>
        </div>
        ...
        <div class="card">
            <div class ="card-body">
                ...
                <p class="card-detail"> Softmore year of Highschool I took AP Computer Science, 
                I learned about Object Oriented Programming and built assignements in Java </p>
            </div>
        </div>
